...
const { getGastos, getGastoById, getGastoByName, getGastosBiggerThan, getGastosSmallerThan, getGastosBetweenDates, postGasto, updateGasto, deleteGasto } = require("../controllers/gastos");
